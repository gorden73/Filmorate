...
public class UserDbStorage implements UserStorage {
    ...
    private static final String SQL_ADD_USERS = "INSERT INTO users(email, login, name, birthday) VALUES (?, ?, ?, ?)";
    private static final String SQL_GET_USER_ID = "SELECT user_id FROM users WHERE email = ? and login = ? and " +
            "name = ? and birthday = ?";
    private static final String SQL_GET_UPDATED_USER = "UPDATE users SET email = ?, login = ?, name = ?, " +
